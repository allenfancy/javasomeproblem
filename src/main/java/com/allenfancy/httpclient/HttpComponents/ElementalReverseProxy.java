...
public class ElementalReverseProxy {
	...
	public static void main(final String[] args) throws Exception {
		...
		final Thread t = new RequestListenerThread(8080, target);
		t.setDaemon(false);
		t.start();
	}
	...
	static class ProxyHandler implements HttpRequestHandler {
		...
		public void handle(HttpRequest request, HttpResponse response, HttpContext context)
			...
			request.removeHeaders("Keep_Alive");
			...
			this.httpexecutor.postProcess(targetResponse, this.httpproc, context);
