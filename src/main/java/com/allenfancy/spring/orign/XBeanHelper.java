...
public class XBeanHelper {
	...
	public static XmlBeanDefinitionReader createBeanDefinitionReader(
			FileSystemXmlApplicationContext1 fileSystemXmlApplicationContext1,
		...
		try{
			...
			return (XmlBeanDefinitionReader) cstr.newInstance(new Object[] {fileSystemXmlApplicationContext1,registry,xmlPreprocessors});
		}catch(Exception e){
			throw (IllegalStateException)new IllegalStateException("Could not find valid implmentation for:" + version).initCause(e);
		}
	}
}
